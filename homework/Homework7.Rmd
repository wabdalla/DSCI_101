...
b) (10 points) What is the theoretical probability of getting a face card (i.e., Jack, Queen, King)? ***Print this probability in your final output***
...
c) (20 points) Use the function created in *part a* to simulate the experimental probability of getting a face card (you must use a function from the `map` family). Use 1000000 iterations. ***Print this experimental probability in your final output.*** 
...
d) (5 points) Compare the difference between the theoretical probability in part b to the experimental probability in part c by subtracting these two numbers. ***Print this difference in your final output***
...
e) (10 points) What is the theoretical probability of getting a numbered card (i.e., 2, 3, .., 10)? ***Print this probability in your final output***
...
f) (20 points) Use the function created in *part a* to simulate the experimental probability of getting a numbered card (you must use a function from the `map` family). Use 1000000 iterations. ***Print this experimental probability in your final output.*** 
...
g) (5 points) Compare the difference between the theoretical probability in part e to the experimental probability in part f by subtracting these two numbers. ***Print this difference in your final output***
