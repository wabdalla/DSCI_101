...
# 1. What airline had the highest departure delay?
...
# 2. Which airlines (actual name) had the most delayed flights departing from NYC in 2013? 
...
# 3. What are the statistics (see below) of flight distances for flights departing from each airport?
...
# 4. What are the top 3 destinations (airport initials) for flights departing from NYC in 2013?
...
# 6. Which airlines (airline name) had the highest average departure delays from each airport?
