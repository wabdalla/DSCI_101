...
Students_001 <- c("Syeda","Grant","Rayn","Emma","Abigail",
                  "Aero","Hannah G.","Het","Geunah","Suzy","Lindsey","Mizuki",
                  "Olu","Jungwoo","Harima","Justin","Kendall","Mar","Alexa","Hannah S.",
                  "Anayatzi","Grace","Nicholas")


sample(Students_001, 10, replace = TRUE)


Students_002 <- c("Maryum A.","Ali","Keonte","Steven","Chongwoo",
                  "Ashley","Carson", "Maya", "Raihan", "Matthew", "Kara","Mariam E.", 
                  "Leo", "Veronica", "Lisa", "Holden", "Anna", "Sai","Amaya", "Noah", 
                  "Joanna", "Nigel", "Robbie", "May", "Tess", "Sophia","Timothy",
                  "Marcos","Oscar","Ryan","Marc","Aadit","Jimmy","Greyson")


sample(Students_002, 10, replace = TRUE)
