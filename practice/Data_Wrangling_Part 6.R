...
# 4. Which airlines (full name) operated the most flights from each origin airport in NYC?



# 5. Which airlines (airline name) had the highest average departure delays from each airport?
