...
map_chr(names, str_to_upper)
map_dbl(names, str_to_upper)
...
map_chr(fruits, str_sub, start = 2, end = 4)
map_dbl(fruits, str_sub, start = 2, end = 4)
...
map(y, question_3)
map_dbl(y, question_3)
map_chr(y, question_3)
...
peak(baby_name = "Adam", df = babynames)
...
results <- map_dfr(top_100_names, peak, df = babynames)

map_dfr(top_100_names,peak) 
# Why is there an error on the previous line? 
# Because we need to account for the second argument of the function.
