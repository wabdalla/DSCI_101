...
# It gives the minimum, first quartile, median, mean, 
...
# Gives you the number of elements in the vector & the class. 

# 6. Compute the mean of the values in vec_2. What is happening? 
mean(vec_2)

# Gave back an NA with a warning message because you cannot
# Compute the mean on a character vector. 
...
if(a<b){
  print(paste("The larger number is ", b))
}else if (a>b){
  print(paste("The larger number is ", a))
}else{
  print(paste("The two numbers, ", a, "and ", b, ", are equal"))
}
...
vector_1 <- 1:7
vector_2 <- c(2, 1, 5, 5, 5, 7, 1)
problem_6<-ifelse(vector_1>=vector_2, "Element in vector 1 is greater or equal", 
                  "Element in vector 2 is greater")
